class Apna{
	...
	boolean isValidated = 	ApnaValidator.validationUser(fName,cName,emp,email);
	
	if(isValidated == true ){
		isJobPosted = true;
	}else System.out.println("the job is not posted");
		...
		public static void getCompanyInfo(){
			...
			fullName = ApnaValidator.fullName;
			companyName = ApnaValidator.companyName;
			employees = ApnaValidator.employees;
			workEmail = ApnaValidator.workEmail;
