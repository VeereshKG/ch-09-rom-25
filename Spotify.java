class Spotify{
	...
	public static boolean signUp(String givenEmail,String pwd,String givenName,String dob,char givenGender){
		...
		boolean isValidation = SpotifyValidator.validateUser(givenEmail,pwd,givenName,dob,givenGender);

	  if(isValidation == true){
		  isSignUPDone = true;
	  }else System.out.println("user is not signup");
	...
	public static void getSignUpDetails(){
		...
		emailAddress=SpotifyValidator.emailAddress;
		password = SpotifyValidator.password;
		name = SpotifyValidator.name;
		dateOfBirth = SpotifyValidator.dateOfBirth;
		gender = SpotifyValidator.gender;
