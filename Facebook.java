...
boolean	isValidation	= FacebookValidator.vaidateUser(fName,sName,dob,gen,mobile,mail,pword);
		 
		 if(isValidation == true ){
		 isAccountCreated = true;
		 }else System.out.println("facebook account is not created ");
		...
		public static void getUser(){
			...
			System.out.println("the first Name :"+FacebookValidator.firstName);
			System.out.println("the sur name of user is  :"+FacebookValidator.surName);
			System.out.println("the dateOfBirth :"+FacebookValidator.dateOfBirth);
			System.out.println("the gender  :"+FacebookValidator.gender);
			System.out.println("the user phone number :"+FacebookValidator.contact);
			System.out.println("the user email id :"+FacebookValidator.email);
			System.out.println("the password :"+FacebookValidator.password);
