class Prime{
 ...
 boolean isvalidation	=	PrimeValidator.uservalidation(fName,number,pwd);
 
 if(isvalidation == true){
	 isAccountCreated = true;
 }else System.out.println("the prime account is not created");
	...
	public static void getAccountDetails(){
		...
		fullName = PrimeValidator.fullName;
		mobileNumber = PrimeValidator.mobileNumber;
		password = PrimeValidator.password;
