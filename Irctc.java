class Irctc{
	...
	public static boolean accountCreate(String uName,String fName,String pword,String confirmPword,String mail,long phone){
		...
		boolean isValidation = IrctcValidator.validateUser(uName,fName,pword,confirmPword,mail,phone);
		
		if(isValidation == true){
			isAccountCreated = true;
		}else System.out.println("your irctc account is not created");
		...
		public static void getUser(){
			userName = IrctcValidator.userName;
			fullName = IrctcValidator.fullName;
			password = IrctcValidator.password;
			confirmPassword = IrctcValidator.confirmPassword;
			email = IrctcValidator.email;
			mobile = IrctcValidator.mobile;
